...
#include "../../include/raw_mini/turtlebot3_sensor.h"
...
void Turtlebot3Sensor::makeMelody(uint8_t index)
{
  ...
  {
    case ON:
      melody_note_[0] = NOTE_C4;
      melody_duration_[0] = 4;
      melody_note_[1] = NOTE_D4;
      melody_duration_[1] = 4;
      melody_note_[2] = NOTE_E4;
      melody_duration_[2] = 4;
      melody_note_[3] = NOTE_F4;
      melody_duration_[3] = 4;
      melody_note_[4] = NOTE_G4;
      melody_duration_[4] = 4;
      melody_note_[5] = NOTE_A4;
      melody_duration_[5] = 4;
      melody_note_[6] = NOTE_B4;
      melody_duration_[6] = 4;
      melody_note_[7] = NOTE_C5;
      melody_duration_[7] = 4;
      break;

    case OFF:
      melody_note_[0] = NOTE_C5;
      melody_duration_[0] = 4;
      melody_note_[1] = NOTE_B4;
      melody_duration_[1] = 4;
      melody_note_[2] = NOTE_A4;
      melody_duration_[2] = 4;
      melody_note_[3] = NOTE_G4;
      melody_duration_[3] = 4;
      melody_note_[4] = NOTE_F4;
      melody_duration_[4] = 4;
      melody_note_[5] = NOTE_E4;
      melody_duration_[5] = 4;
      melody_note_[6] = NOTE_D4;
      melody_duration_[6] = 4;
      melody_note_[7] = NOTE_C4;
      melody_duration_[7] = 4;
      break;

    case LOW_BATTERY:
      melody_note_[0] = 1000;
      melody_duration_[0] = 1;
      melody_note_[1] = 1000;
      melody_duration_[1] = 1;
      melody_note_[2] = 1000;
      melody_duration_[2] = 1;
      melody_note_[3] = 1000;
      melody_duration_[3] = 1;
      melody_note_[4] = 0;
      melody_duration_[4] = 8;
      melody_note_[5] = 0;
      melody_duration_[5] = 8;
      melody_note_[6] = 0;
      melody_duration_[6] = 8;
      melody_note_[7] = 0;
      melody_duration_[7] = 8;
      break;

    case ERROR:
      melody_note_[0] = 1000;
      melody_duration_[0] = 3;
      melody_note_[1] = 500;
      melody_duration_[1] = 3;
      melody_note_[2] = 1000;
      melody_duration_[2] = 3;
      melody_note_[3] = 500;
      melody_duration_[3] = 3;
      melody_note_[4] = 1000;
      melody_duration_[4] = 3;
      melody_note_[5] = 500;
      melody_duration_[5] = 3;
      melody_note_[6] = 1000;
      melody_duration_[6] = 3;
      melody_note_[7] = 500;
      melody_duration_[7] = 3;
      break;
